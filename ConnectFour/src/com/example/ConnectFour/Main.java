...
//		Stage.setResizable(false);
	...
	private void aboutMe() {
		...
		alert.setHeaderText("Shivank Singhal");
		alert.setContentText("I love to play around with code and create games." +
				" Connect 4 is one of them. I also like doing Competitive Programming " +
				", Android development.");
		alert.show();
	}
	...
	private void aboutGame() {
		...
		alert.setContentText("Connect Four is a two-player connection game in which the players first" +
				...
				"is to be the first to form a horizontal, vertical, or diagonal line of four of one's " +
